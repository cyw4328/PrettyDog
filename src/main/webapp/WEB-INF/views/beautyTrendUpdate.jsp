...
<body>
	...
	<form action="trendUpdate" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="community_sub" value="${beautyTrendDetail.community_sub }">
		<h4>내용</h4>
		<input type="text" name="community_cont" value="${beautyTrendDetail.community_cont }">
		...
		<button id="ch" onclick="location.href='beautyTrendList?idx=${beautyTrendDetail.community_boardnum}'">수정</button>
	</form>
