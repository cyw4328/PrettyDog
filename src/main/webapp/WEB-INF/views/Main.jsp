...
<body id="body" >
    ...
    <section style="width: 100%; height: auto; background-color: rgb(255, 255, 255);">
        ...
        <div class="container">
            <div class="row" style="height: 200px;">
                <div class="col-md-3" style="height: 200px;">
                    <img style=" height: 100%;" alt="Bootstrap Image Preview" src="./resources/img/images.png" class="rounded-circle" />
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5" style="border: solid; border-width: 1px; border-color: rgb(200, 200, 200); display: flex; justify-content: center; align-items: center;">
