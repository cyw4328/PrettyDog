...
MyBoardPageList(currPage,5);


function MyBoardPageList(page,cnt) {
...
function listDraw(list) {
    ...
    list.forEach(function(item,community_boardnum) {
    	var date = new Date(item.community_date);
 
		content +='<tr>';
		content +='<td>'+item.community_sub+'</td>';
		content +='<td>'+'<a href="#">'+item.community_cont+'</a>'+'</td>';
